      ...
      <div className="p-8 sm:p-12 relative">
        <div className="terminal-hero-content flex flex-col items-start gap-6 relative z-10">
          <div className="flex-1 w-full">
            <div className="mono text-lg sm:text-xl md:text-2xl neon-text whitespace-pre-line min-h-[120px] sm:min-h-[140px] leading-relaxed font-medium">
              {text}
              <span className="inline-block w-2.5 h-[1em] bg-[#818cf8] animate-pulse ml-1 align-middle rounded-sm opacity-80"></span>
            </div>
            
            <p className="text-[#6b6b80] text-sm mono mt-8 border-l-2 border-[#818cf8]/40 pl-4 py-1">
        ...
        {isReady && (
          <div className="mt-10 flex flex-wrap gap-3 animate-fade-in-up relative z-10">
            <button 
              onClick={() => document.getElementById('skills-section')?.scrollIntoView({ behavior: 'smooth' })} 
              className="px-6 py-2.5 bg-[#818cf8] text-white hover:bg-[#6366f1] transition-all duration-300 mono text-sm font-medium rounded-lg flex items-center gap-2 shadow-[0_0_20px_rgba(99,102,241,0.2)] hover:shadow-[0_0_30px_rgba(99,102,241,0.35)]"
            >
              <ArrowDown size={14} />
              View Skills
            </button>
            <button 
              ...
              className="px-6 py-2.5 border border-[#818cf8]/30 text-[#a5b4fc] hover:bg-[#818cf8]/10 hover:border-[#818cf8]/50 transition-all duration-300 mono text-sm font-medium rounded-lg"
            >
              Contact Me
            </button>
            <a 
              ...
              download 
              className="px-6 py-2.5 border border-[#f472b6]/30 text-[#f472b6] hover:bg-[#f472b6]/10 hover:border-[#f472b6]/50 transition-all duration-300 mono text-sm font-medium rounded-lg flex items-center gap-2"
            >
              <Download size={14} />
              Resume
            </a>
