        ...
        {isReady && (
          <div className="mt-10 flex flex-col sm:flex-row flex-wrap gap-6 animate-in fade-in slide-in-from-bottom-5 duration-1000 justify-between items-center relative z-10">
            <div className="flex flex-wrap gap-6 w-full sm:w-auto">
              <button onClick={() => document.getElementById('skills-section')?.scrollIntoView({ behavior: 'smooth' })} className="flex-1 sm:flex-none relative overflow-hidden px-6 sm:px-8 py-3 border-2 border-[#00f0ff] text-[#00f0ff] hover:bg-[#00f0ff]/20 transition-all duration-500 mono text-sm sm:text-base font-black flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(0,240,255,0.2)] hover:shadow-[0_0_40px_rgba(0,240,255,0.5)] group uppercase tracking-widest rounded-sm">
              ...
              <button onClick={() => document.getElementById('contact')?.scrollIntoView({ behavior: 'smooth' })} className="flex-1 sm:flex-none relative overflow-hidden px-6 sm:px-8 py-3 border-2 border-[#ff003c] text-[#ff003c] hover:bg-[#ff003c]/20 transition-all duration-500 mono text-sm sm:text-base font-black flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(255,0,60,0.2)] hover:shadow-[0_0_40px_rgba(255,0,60,0.5)] group uppercase tracking-widest rounded-sm">
              ...
              <a href="/Aryan_Barde_Resume.pdf" download className="flex-1 sm:flex-none relative overflow-hidden px-6 sm:px-8 py-3 border-2 border-[#ffaa44] text-[#ffaa44] hover:bg-[#ffaa44]/20 transition-all duration-500 mono text-sm sm:text-base font-black flex items-center justify-center gap-3 shadow-[0_0_20px_rgba(255,170,68,0.2)] hover:shadow-[0_0_40px_rgba(255,170,68,0.5)] group uppercase tracking-widest rounded-sm">
